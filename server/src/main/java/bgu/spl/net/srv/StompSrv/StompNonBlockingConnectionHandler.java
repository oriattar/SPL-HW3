...
public class StompNonBlockingConnectionHandler implements ConnectionHandler<String> {
    ...
    public StompNonBlockingConnectionHandler(
    ...
    public void close() {
        try {
            chan.close();
            protocol.handleDisconnect(); //disconnects user
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    }
