...
public class StompReactor implements Server<String> {
    ...
    private AtomicInteger conIdGen;
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector) throws IOException {
        ...
        final StompNonBlockingConnectionHandler handler = new StompNonBlockingConnectionHandler(
                readerFactory.get(),
                protocolFactory.get(),
                clientChan,
                this,
    ...
    private void handleReadWrite(SelectionKey key) {
        ...
        StompNonBlockingConnectionHandler handler = (StompNonBlockingConnectionHandler)key.attachment();
